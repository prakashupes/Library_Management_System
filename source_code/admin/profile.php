    ...
    <body>
        ...
        <div class="profile">
            <div class="profilepic">
                ...
                <div class="prolabel001" ><label >Name</label><label class="prolabel002"><?php echo $row['name']?></label></div><br>
                <div class="prolabel001" ><label >Email</label><label class="prolabel002"><?php echo $row['email']?></label></div><br>
                <div class="prolabel001" ><label>Gender </label><label class="prolabel002"><?php echo $row['gender']?></label></div><br>
                <div class="prolabel001"><label >Mobile</label><label class="prolabel002"><?php echo $row['mobile']?></label></div><br>
                <div class="prolabel001"><label >Address1</label><label class="prolabel002"><?php echo $row['address1']?></label></div><br>
                <div class="prolabel001"><label >City</label><label class="prolabel002"><?php echo $row['city']?></label></div><br>
                <div class="prolabel001"><label >Postal</label><label class="prolabel002"><?php echo $row['zip']?></label></div><br>
